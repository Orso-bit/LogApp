...
struct DiameterMeasurementForNewTreeView: View {
            ...
            .sheet(isPresented: $showingResult) {
                SaveNewDiameterView(
                    ...
                    onSave: { diameter, notes in
                        saveTreeWithDiameter(diameter: diameter, notes: notes)
                    }
                )
            }
        }
    ...
    private func saveTreeWithDiameter(diameter: Double, notes: String) {
        ...
        // Crea la misurazione
        let treeProiection = TreeProiection(diameter: diameter, notes: notes, tree: newTree)
        
        // Aggiungi la misurazione all'albero
        newTree.treeProiection.append(treeProiection)
...
struct SaveNewDiameterView: View {
    @Environment(\.dismiss) private var dismiss
